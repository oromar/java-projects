...
public class Input extends JFrame {
	...
	public Input() {
		...
		btnExit.setBounds(481, 532, 89, 23);
		...
		btnSalvar.setBounds(382, 532, 89, 23);
		...
		btnNovo.setBounds(10, 532, 89, 23);
		contentPane.add(btnNovo);
		
		JTabbedPane tabbedPane = new JTabbedPane(JTabbedPane.TOP);
		tabbedPane.setBounds(10, 11, 560, 510);
		...
		panel_2.setBounds(10, 125, 535, 143);
		panel_3.add(panel_2);
		...
		button_2.setIcon(new ImageIcon("Icones\\accept.png"));
		button_2.setToolTipText("Add Produto");
		button_2.setBounds(444, 108, 84, 28);
		panel.add(button_2);
		
		JScrollPane scrollPane_1 = new JScrollPane();
		scrollPane_1.setBounds(10, 166, 537, 305);
